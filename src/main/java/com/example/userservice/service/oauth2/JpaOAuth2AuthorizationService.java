...
import com.example.userservice.repository.oauth2.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        ...
        Map<String, Object> attributes = convertAttributes(entity.getAttributes());
    ...
    private Map<String, Object> convertAttributes(String data) {
        Map<String, Object> attributes = parseMap(data);

        Object authorizationRequest = attributes.get(OAuth2AuthorizationRequest.class.getName());
        if (authorizationRequest instanceof Map<?, ?> mapValue) {
            attributes.put(
                    OAuth2AuthorizationRequest.class.getName(),
                    this.objectMapper.convertValue(mapValue, OAuth2AuthorizationRequest.class)
            );
        }

        Object authentication = attributes.get(Authentication.class.getName());
        if (authentication instanceof Map<?, ?> mapValue) {
            attributes.put(
                    Authentication.class.getName(),
                    this.objectMapper.convertValue(mapValue, Authentication.class)
            );
        }

        Object principal = attributes.get("java.security.Principal");
        if (principal instanceof Map<?, ?> mapValue) {
            attributes.put(
